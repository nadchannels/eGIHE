...
import {
  ...
  CheckCircle, AlertTriangle, Info, Printer, Eye, Users, Building2
} from 'lucide-react';
      ...
      <div className="att-print-area">
        ...
        <div className="att-controls att-no-print">
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem' }}>
            <button id="batt-sa-pdf-btn" className="btn btn-secondary" onClick={() => window.print()} disabled={currentTrainers.length === 0}>
              <Printer size={16} /> PDF
            </button>
      ...
      <div className="att-print-area">
        ...
        <div className="att-controls att-no-print">
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button id="batt-pdf-btn" className="btn btn-secondary" onClick={() => window.print()} disabled={trainers.length === 0}>
              <Printer size={16} /> PDF
            </button>

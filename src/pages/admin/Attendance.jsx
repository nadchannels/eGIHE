...
import {
  ...
  CheckCircle, AlertTriangle, Info, Printer, Eye, Users
} from 'lucide-react';
      ...
      <div className="att-print-area">
        ...
        <div className="att-controls att-no-print">
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem' }}>
            <button id="att-sa-pdf-btn" className="btn btn-secondary" onClick={() => window.print()} disabled={currentTrainees.length === 0}>
              <Printer size={16} /> PDF
            </button>
      ...
      <div className="att-print-area">
        ...
        <div className="att-controls att-no-print">
          ...
          <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            <button id="att-pdf-btn" className="btn btn-secondary" onClick={() => window.print()} disabled={trainees.length === 0}>
              <Printer size={16} /> PDF
            </button>
